...
CREATE TABLE modelos_vehiculo (
  ...
  modelo VARCHAR(100) NOT NULL,
  anio YEAR NOT NULL,
  rendimiento_oficial FLOAT NOT NULL,
  tipo_combustible_id INT,
  KEY fk_tipo_combustible (tipo_combustible_id),
  FOREIGN KEY (tipo_combustible_id) REFERENCES tipos_combustible(id) ON DELETE SET NULL,
  UNIQUE KEY unique_modelo (marca, modelo, anio)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Insertar los modelos (ejecuta en bloques si es muy largo)
INSERT INTO modelos_vehiculo (marca, modelo, anio, rendimiento_oficial, tipo_combustible_id) VALUES
('Toyota', 'Corolla', 2020, 14.5, NULL),
('Toyota', 'Corolla', 2021, 14.8, NULL),
('Toyota', 'Corolla', 2022, 15.2, NULL),
('Toyota', 'Corolla', 2023, 15.5, NULL),
('Toyota', 'Corolla', 2024, 16.0, NULL),
('Toyota', 'RAV4', 2020, 11.5, NULL),
('Toyota', 'RAV4', 2021, 11.8, NULL),
('Toyota', 'RAV4', 2022, 12.2, NULL),
('Toyota', 'RAV4', 2023, 12.5, NULL),
('Toyota', 'RAV4', 2024, 13.0, NULL),
('Chevrolet', 'Spark', 2020, 16.5, NULL),
('Chevrolet', 'Spark', 2021, 16.8, NULL),
('Chevrolet', 'Spark', 2022, 17.2, NULL),
('Chevrolet', 'Spark', 2023, 17.5, NULL),
('Chevrolet', 'Spark', 2024, 18.0, NULL),
('Chevrolet', 'Cruze', 2020, 13.5, NULL),
('Chevrolet', 'Cruze', 2021, 13.8, NULL),
('Chevrolet', 'Cruze', 2022, 14.2, NULL),
('Hyundai', 'i20', 2020, 15.5, NULL),
('Hyundai', 'i20', 2021, 15.8, NULL),
('Hyundai', 'i20', 2022, 16.2, NULL),
('Hyundai', 'Tucson', 2020, 12.0, NULL),
('Nissan', 'March', 2020, 15.8, NULL),
('Kia', 'Picanto', 2020, 16.0, NULL),
('Volkswagen', 'Polo', 2020, 15.2, NULL);
